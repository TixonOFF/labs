...
public class LSingleDirectionalList<T extends Comparable> extends SingleDirectionalList
{
    protected ArrayList<T> array;
    protected int pointer;


    public LSingleDirectionalList(ArrayList<T> array)
    {
        this.array = array;
        pointer = 0;
    }
    ...
    public void addList(LSingleDirectionalList list)
    {
        array.addAll(list.array);
        begin();
    }

    public LSingleDirectionalList detachList(int pos)
    {
        if (pos > 0 && pos < size())
        {
            ...
            return new LSingleDirectionalList(list2);
        }
