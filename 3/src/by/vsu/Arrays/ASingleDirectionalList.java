...
public class ASingleDirectionalList<T extends Comparable> extends SingleDirectionalList
{
    protected T[] array;
    protected int pointer;


    public ASingleDirectionalList(T[] array)
    {
        this.array = array;
        pointer = 0;
    }
    ...
    public void addList(ADoubleDirectionalList list)
    {
    ...
    public ADoubleDirectionalList detachList(int pos)
    {
        if (pos > 0 && pos < size())
        {
            T[] list = array.clone();
            ...
            return new ADoubleDirectionalList(Arrays.copyOfRange(list, pos, list.length).clone());
        }
